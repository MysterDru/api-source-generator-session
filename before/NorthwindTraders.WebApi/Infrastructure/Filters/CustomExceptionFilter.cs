...
public sealed class CustomExceptionFilterAttribute(ProblemDetailsFactory problemDetailsFactory)
    : ExceptionFilterAttribute
{
    public override void OnException(ExceptionContext context)
    {
        ...
        var details = problemDetailsFactory.CreateProblemDetails(context.HttpContext, (int) code, null, null, message);
